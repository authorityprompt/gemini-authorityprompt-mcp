...
const DEFAULTS = { apiUrl: "https://authorityprompt.com", defaultDomain: "authorityprompt.com", timeoutMs: 10000, cacheTtlSeconds: 300, logLevel: "info" };
...
export function loadConfig(argv = process.argv, env = process.env) {
    ...
    const logLevel = (readArg("log-level", argv) || env.AUTHORITYPROMPT_LOG_LEVEL || DEFAULTS.logLevel);
    return {
        apiUrl,
        defaultDomain,
