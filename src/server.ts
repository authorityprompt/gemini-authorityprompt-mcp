...
const TOOL_HANDLERS: Record<string, (client: AuthorityPromptClient, input: Record<string, unknown>) => Promise<unknown>> = {
...
export function createAuthorityPromptServer(config: AuthorityPromptConfig): Server {
...
export async function startServer(config: AuthorityPromptConfig): Promise<void> {
